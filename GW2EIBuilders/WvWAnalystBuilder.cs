    ...
    private static WvWAnalystFightPayloadDto? Build(ParsedEvtcLog log, Version parserVersion, string sourceFileName)
    {
        ...
        return new WvWAnalystFightPayloadDto
        {
            ...
            Fight = new WvWAnalystFightDto
            {
                ...
                GameBuild = log.LogMetadata.GW2Build,
                ArcVersion = log.LogMetadata.ArcVersionBuild,
            },
        ...
        CombatReplayAnalysisDto? analysis)
    {
        ...
        return new WvWAnalystOutcomeAnalysisDto
        {
            ...
            Availability = new WvWAnalystOutcomeAnalysisAvailabilityDto
            {
                ...
                SquadConditionApplications = analysis.SquadConditions.DataAvailable,
                EnemyConditionApplications = analysis.IncomingConditions.DataAvailable,
                CrowdControlEvents =
                    analysis.SquadCrowdControl.DataAvailable ||
