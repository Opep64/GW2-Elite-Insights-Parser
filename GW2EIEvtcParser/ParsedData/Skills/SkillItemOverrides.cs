...
#region ArcDPS
        ...
        { ArcDPSGenericInterrupt, "Interrupt" },
        { ArcDPSGenericKnockdown, "Knockdown" },
        { ArcDPSGenericKnockbackPull, "Knockback / Pull" },
        { ArcDPSGenericFloat, "Float" },
        { ArcDPSGenericLaunch, "Launch" },
        { ArcDPSGenericWaterFloatSink, "Float / Sink (Water)" },
        { ArcDPSGenericCCBuff, "Crowd Control" },
        { ArcDPSGenericStagger, "Stagger" },
        { ArcDPSGenericFloatWater, "Float (Water)" },
        { ArcDPSGenericSink, "Sink" },
        { ArcDPSGenericLockOut, "Lockout" },
        { ArcDPSGenericFear, "Fear" },
